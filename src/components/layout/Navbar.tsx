    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center h-16 lg:h-20">
          ...
          {/* Get Started Button */}
          <motion.button
            className="px-6 py-2 bg-gradient-to-r from-[#A1BFFF] via-white to-[#A649D2] text-gray-900 font-medium hover:from-[#8FA9FF] hover:via-gray-100 hover:to-[#9440C2] transition-all duration-200 rounded-lg"
        ...
        {isOpen && (
          ...
          >
            <div className="px-4 py-6 space-y-4">
              ...
              <button className="w-full mt-4 px-6 py-3 bg-gradient-to-r from-purple-600 to-blue-600 rounded-lg text-white font-medium">
                Get Started
              </button>
            </div>
          </motion.div>
