        ...
        >
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-12 pb-10">
              ...
              <motion.button
                className="group px-8 py-4 border border-white/20 rounded-full text-white font-semibold text-lg flex items-center space-x-2 hover:bg-white/10 transition-all duration-300 backdrop-blur-sm"
                whileHover={{ scale: 1.05, y: -2 }}
                whileTap={{ scale: 0.95 }}
              >
