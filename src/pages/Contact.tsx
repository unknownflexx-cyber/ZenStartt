      ...
      <section className="py-24 relative overflow-hidden bg-black">
        ...
        <div className="max-w-7xl mx-auto px-7 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-200 dark:text-gray-400 max-w-3xl mx-auto mb-12">
            ...
            >
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 hover:bg-white/10 transition-all duration-500 hover:scale-105">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <motion.button
                    type="submit"
                    className="w-full px-8 py-4 bg-gradient-to-r from-[#A1BFFF] via-white to-[#A649D2] rounded-lg text-gray-900 font-semibold text-lg flex items-center justify-center space-x-2 hover:from-[#8FA9FF] hover:via-gray-100 hover:to-[#9440C2] transition-all duration-300 shadow-lg"
